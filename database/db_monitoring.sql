...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2022 at 08:34 PM
...
INSERT INTO `t_blok` (`id_blok`, `kode_blok`, `kode_user`, `nama_blok`, `alamat_blok`, `lat_blok`, `long_blok`, `create_at`, `create_by`, `modify_at`, `modify_by`) VALUES
(22, 'SVR00022', 'USR0002', 'Test Server', 'Test Server', -6.308600426541275, 106.75859645624242, '2022-08-08 00:56:06', 'Adam', '2022-09-01 10:50:42', 'Adam'),
(23, 'SVR00023', 'USR0005', 'UIN Jakarta', 'Test UIN', -6.202669326266531, 106.83518234099971, '2022-09-01 14:05:06', 'Khair Baru', NULL, NULL);
...
INSERT INTO `t_client` (`id_client`, `kode_klient`, `kode_blok`, `kode_user`, `ip_client`, `nama_client`, `lat_client`, `long_client`, `status_client`) VALUES
(27, 'CLIENT00000027', 'SVR00022', 'USR0002', '192.168.8.100', 'Kampus 2', -6.309156037134768, 106.75939730161542, 0);
...
INSERT INTO `t_histori` (`id_histori`, `id_users`, `kegiatan`, `data`, `tgl`, `jam`, `ip`, `browser`) VALUES
...
INSERT INTO `t_users` (`id_users`, `kode_user`, `nopeg`, `nama`, `email`, `password`, `nohp`, `alamat`, `foto`, `id_level`, `blokir`) VALUES
(4, 'USR0002', '1234567', 'Adam', 'admin@admin.com', '202cb962ac59075b964b07152d234b70', '0812345678900', 'Jakarta Selatan', 'no-image.png', 1, 'N'),
(42, 'USR0005', 'KH11122', 'Khair Baru', 'Khair@gmail.com', '202cb962ac59075b964b07152d234b70', '081631276213', 'Depok', 'unnamed-removebg-preview2.png', 1, 'N');
...
--
ALTER TABLE `t_blok`
  ADD PRIMARY KEY (`id_blok`,`kode_blok`),
...
ALTER TABLE `t_client`
  ADD PRIMARY KEY (`id_client`,`kode_blok`),
  ADD KEY `key` (`kode_blok`),
...
--
-- AUTO_INCREMENT for table `t_blok`
--
ALTER TABLE `t_blok`
  MODIFY `id_blok` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `t_client`
--
ALTER TABLE `t_client`
  MODIFY `id_client` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT for table `t_histori`
--
ALTER TABLE `t_histori`
  MODIFY `id_histori` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=354;
--
...
--
ALTER TABLE `t_users`
  MODIFY `id_users` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
