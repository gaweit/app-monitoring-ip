...
class Ajax extends CI_Controller {
	...
	function pingIp(){
		...
		echo $no = 1; foreach ($record as $row) { echo "<tr>
        ...
        echo "</td>
            <td>
                <center>
                    ...
                    <a href='".base_url()."device/ubah_device/$row[id_client]' class=\"badge badge-success\" title='Edit'>
                        <i class=\"far fa-edit\">		Edit</i>
                    </a>
                    <a href='".base_url()."device/hapus_device/$row[id_client]' class=\"badge badge-danger\" onClick=\"javascript: return confirm('Anda yakin ingin menghapusnya ?');\" title='Hapus'>
