<div class="col-sm-12">
    <div class="card">
        <div class="card-body">
            ...
            <?php $attributes = array('class'=>'form-horizontal','role'=>'form','autocomplete'=>'off'); echo form_open_multipart('device/ubah_device',$attributes); ?>
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                
                <div class="form-group row">
                    <label for="example-text-input" class="col-2 col-form-label">Nama</label>
                    <div class="col-10">
                        <input class="form-control" type="hidden" name="kode" value="<?=$row['kode_klient']?>">
                        <input class="form-control" type="text" name="c" value="<?=$row['nama_client']?>">
                    </div>
                </div>
                        ...
                        <select class="form-control" name="a">
                            ...
                            <?php  
                                foreach ($serv as $key => $value) {
                                    $pilih = 'selected';
                                    if ($value['kode_blok']==$row['kode_blok']) {
                                        echo "<option value='$value[kode_blok]' $pilih> $value[nama_blok] </option>";
                                    }else{
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="text" name="d" value="<?=$row['lat_client']?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="text" name="e" value="<?=$row['long_client']?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control ip-inputmask" name="b" value="<?=$row['ip_client']?>">
                    </div>
                </div>
                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" name="f" class="form-control" value="<?=$row['rute_client']?>">
                    </div>
                </div> -->
