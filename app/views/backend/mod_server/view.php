                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        ...
                                        <a href="<?= base_url() . 'server/ubah_server/' . $row['kode_blok']; ?>" class="badge badge-success">
                                            <i class="far fa-edit"> Edit</i>
                                        </a>
                                        <a href="<?= base_url() . 'server/hapus_server/' . $row['kode_blok']; ?>" class="badge badge-danger" onClick="javascript: return confirm('Anda yakin ingin menghapusnya ?');">
